...
using Acme.BookStore.CosmosServices;
...
public class BookStoreWebModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddSingleton<ICosmosDbService>(new CosmosDbService(
        configuration.GetConnectionString("CosmosDB"),
        configuration["CosmosDbSettings:DatabaseName"],
        configuration["CosmosDbSettings:ContainerName"]
    ));
